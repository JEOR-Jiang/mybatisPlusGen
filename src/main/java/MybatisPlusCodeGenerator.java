...
public class MybatisPlusCodeGenerator {
    ...
    public static void main(String[] args) {
        //====================配置变量区域=====================//
        String author="jeor";//生成文件的作者，可以不填
        ...
        //数据库配置
        String url="jdbc:mysql://10.91.231.xx:xxx/bt?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8&allowMultiQueries=true";
        String driverClassName="com.mysql.jdbc.Driver";//或者com.mysql.cj.jdbc.Driver
        String username="xx";
        String password="xxxxx";
        String tableNames="tableName";//表名，多个使用,分隔
        //====================配置变量区域=====================//
